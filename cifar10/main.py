...
onnxFile = "./model.onnx"
trtFile = "./model.plan"
inferenceImage = "/data/data/cifar10/cali/1.jpg"

isFP16Mode = False
isINT8Mode = True
nCalibration = 500
cacheFile = "./int8.cache"
calibrationDataPath = "/data/data/cifar10/cali/"
...
ckpt = torch.load("/data/data/cifar10/resnet18.pth", map_location="cpu")
...
test_set = datasets.CIFAR10(root='/data/data/cifar10', train=False, download=True, transform=transform_test)
